...
import com.example.tubes_ppb.AgentView.*
...
class Agent : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnGekko: ImageButton = findViewById(R.id.button_gekko)
        btnGekko.setOnClickListener(this)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.button_gekko -> {
                val gekkoIntent = Intent(this@Agent, Gekko::class.java)
                startActivity(gekkoIntent)
            }
            R.id.button_jett -> {
