...
class Gekko : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_gekko)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.side_nav -> {
                ...
                val rootView: ViewGroup = findViewById(R.id.gekko_layout)
                ...
                mFragmentManager
                    .beginTransaction()
                    .add(R.id.gekko_layout, mSideNavFragment,
