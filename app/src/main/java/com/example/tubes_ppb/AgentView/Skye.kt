...
class Skye : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_skye)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.side_nav -> {
                ...
                val rootView: ViewGroup = findViewById(R.id.skye_layout)
                ...
                mFragmentManager
                    .beginTransaction()
                    .add(
                        R.id.skye_layout, mSideNavFragment,
