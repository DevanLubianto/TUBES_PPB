...
class Kayo : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kayo)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.side_nav -> {
                ...
                val rootView: ViewGroup = findViewById(R.id.kayo_layout)
                ...
                mFragmentManager
                    .beginTransaction()
                    .add(R.id.kayo_layout, mSideNavFragment,
