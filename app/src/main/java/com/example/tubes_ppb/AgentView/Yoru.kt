...
class Yoru : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_yoru)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.side_nav -> {
                ...
                val rootView: ViewGroup = findViewById(R.id.yoru_layout)
                ...
                mFragmentManager
                    .beginTransaction()
                    .add(
                        R.id.yoru_layout, mSideNavFragment,
