...
class Brimstone : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.side_nav -> {
                ...
                val rootView: ViewGroup = findViewById(R.id.brimstone_layout)
                ...
                mFragmentManager
                    .beginTransaction()
                    .add(R.id.brimstone_layout, mSideNavFragment,
